...
function Projects() {
    return(
        ...
        <img className="w-100 col-sm-7 mt-2 shadow-lg p-1 bg-white" src="./MiniProject.png" alt=""></img>
        ...
        <img className="w-100 col-sm-7 shadow-lg p-1 bg-white" src="./ConferenceSite.png" alt=""></img>
        </div>

        <div className="row d-flex pt-5">
        <img className="w-100 col-sm-6 mt-3 mr-3 shadow-lg p-1 bg-white" src="./2048.png" alt="" style={{height:"500px",width:"70px"}}></img>
